...
def _classify_domains_llm(roots, brand, category, competitor_names=None, batch=60):
    ...
    for i in range(0, len(todo), batch):
        ...
        prompt = (
            ...
            f'- community: user DISCUSSION — forums, Q&A, message boards (Reddit, Quora, '
            f'Stack Exchange, niche forums)\n'
            f'- social: user-authored pages on feed/video platforms (Facebook, YouTube, Instagram, '
            f'TikTok, LinkedIn, X, Pinterest). Discussion forums are community, not social. '
            f'NOT news portals\n'
